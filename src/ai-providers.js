...
export class AIProviders {
    ...
    async callAnthropic(prompt) {
        ...
        const payload = {
            ...
            messages: messages,
            system: "You are a senior software engineer and security expert specializing in comprehensive code review. You have deep expertise in multiple programming languages, security vulnerabilities, performance optimization, and software engineering best practices. Analyze code with the rigor of a principal engineer conducting critical system reviews. Return only valid JSON responses with detailed technical insights.",
            temperature: 0.1
        };
            ...
            contents: [
                {
                    parts: [
                        {
                            text: `You are a senior software engineer and security expert specializing in comprehensive code review. You have deep expertise in multiple programming languages, security vulnerabilities, performance optimization, and software engineering best practices. 

Analyze code with the rigor of a principal engineer conducting critical system reviews. Leverage Google's advanced reasoning capabilities to provide thorough technical analysis.

CRITICAL OUTPUT REQUIREMENTS:
- MUST return ONLY valid, complete JSON in your response
- Do not wrap the JSON in markdown code blocks or backticks  
- Do not include any text outside the JSON object
- Start your response directly with { and end with }
- Ensure the JSON is properly formatted and not truncated
